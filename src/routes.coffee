...
module.exports = (app, streamable) ->
  ...
  #my custom routing
  app.get('/posts/search/:baseLabel', (req, res, next) ->
    console.log "hitting search route from routes.coffee"
    postsController = require("./controllers/posts")
    postsController.search(req, res)
  )

  #cant fit this into routes file because of the need to find a way 
#to export streamable

  app.get('/posts/streamSearch/:baseLabel', streamable, (req, res, next) ->
    console.log "hitting search route from routes.coffee"
    postsController = require("./controllers/posts")
    postsController.streamSearch(req, res)
  )
